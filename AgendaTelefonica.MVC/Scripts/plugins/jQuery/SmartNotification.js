...
$.SmartMessageBox = function (settings, callback) {
    ...
    if (settings.input != undefined) {
        ...
        switch (settings.input) {
            ...
            case "textarea":
                settings.inputValue = $.type(settings.inputValue) === 'string' ? settings.inputValue.replace(/'/g, "&#x27;") : settings.inputValue;
                InputType = "<textarea rows='5' class='form-control' type='" + settings.input + "' id='TextAreaModal' placeholder='" + settings.placeholder + "' value='" + settings.inputValue + "'/><br/><br/>";
                break;
            ...
            case "select":
                ...
                InputType = "<select class='form-control' id='ComboModal'>";
                InputType += "<option value=''> Selecione.. </option>";
                for (var i = 0; i <= settings.options.length - 1; i++) {
                    InputType += "<option value='" + settings.options[i].Value + "'>" + settings.options[i].Text + "</option>"
                };
                InputType += "</select> "
    ...
    Content = "<div class='MessageBoxContainer animated fadeIn fast' name='mscontainer' id='Msg" + SmartMSGboxCount +
        "'>";
    ...
    //Content += "<label style='color: #000000 ' id='ModelValidacao' class='note ValidaModel'>Campo Obrigatorio</label>";
    ...
    $(".botTempo").click(function () {
        ...
        $("#MsgBox").addClass("animated fadeOut fast");
        SmartMSGboxCount = SmartMSGboxCount - 1;
