...
namespace AgendaTelefonica.MVC.Helpers.UTIL
{
    /// <summary>
    ...
    public static class DTCustomFilter
    {
        public static void ObterValoresTGLBoolean(string valorFiltro, ref bool todos, ref bool unitario)
        {
            todos = true;
            unitario = false;
            ...
            {
                if (Convert.ToInt32(valorFiltro) != 2)
                {
                    todos = false;
                    unitario = Convert.ToBoolean(Convert.ToInt32(valorFiltro));
                }
            }
        }
    }
